...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'aqua_gait' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shabirmean/Desktop/COMP765/Assignment1/install/${idir}'.  Ask the maintainer 'Juan Camilo Gamboa Higuera <gamboa@cim.mcgill.ca>, Anqi Xu <anqixu@cim.mcgill.ca>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shabirmean/Desktop/COMP765/Assignment1/install/lib;/home/shabirmean/Desktop/COMP765/Assignment1/devel/lib;/home/shabirmean/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
