...
"""autogenerated by genpy from aquacore/SetStringRequest.msg. Do not edit."""
import sys
...
class SetStringRequest(genpy.Message):
  ...
  _type = "aquacore/SetStringRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from aquacore/SetStringResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SetStringResponse(genpy.Message):
  ...
  _type = "aquacore/SetStringResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
"""
  __slots__ = []
