...
"""autogenerated by genpy from aquacore/SwimForwardActionFeedback.msg. Do not edit."""
import sys
...
class SwimForwardActionFeedback(genpy.Message):
  _md5sum = "b65f4b4cea356807004ece6137de7bd1"
  _type = "aquacore/SwimForwardActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','aquacore/SwimForwardFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwimForwardActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = aquacore.msg.SwimForwardFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = aquacore.msg.SwimForwardFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.feedback.percent_time_completed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.percent_time_completed,) = _get_struct_d().unpack(str[start:end])
      return self
