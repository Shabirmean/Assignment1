...
"""autogenerated by genpy from aquacore/GPSFixList.msg. Do not edit."""
import sys
...
class GPSFixList(genpy.Message):
  _md5sum = "9b7c260d015d47b2d1fb72deb079fdb5"
  _type = "aquacore/GPSFixList"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """sensor_msgs/NavSatFix[] fixList
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GPSFixList, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.fixList is None:
        self.fixList = []
    else:
      self.fixList = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.fixList)
      buff.write(_struct_I.pack(length))
      for val1 in self.fixList:
        _v1 = val1.header
