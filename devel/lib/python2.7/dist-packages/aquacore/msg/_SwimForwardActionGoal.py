...
"""autogenerated by genpy from aquacore/SwimForwardActionGoal.msg. Do not edit."""
import sys
...
class SwimForwardActionGoal(genpy.Message):
  _md5sum = "b588c6db3de822380c09ea3326ae8bbd"
  _type = "aquacore/SwimForwardActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','aquacore/SwimForwardGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwimForwardActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = aquacore.msg.SwimForwardGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = aquacore.msg.SwimForwardGoal()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_2d2f().pack(_x.goal.duration, _x.goal.speed, _x.goal.target_depth, _x.goal.target_yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.duration, _x.goal.speed, _x.goal.target_depth, _x.goal.target_yaw,) = _get_struct_2d2f().unpack(str[start:end])
      return self
