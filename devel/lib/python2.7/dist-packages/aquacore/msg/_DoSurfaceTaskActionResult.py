...
"""autogenerated by genpy from aquacore/DoSurfaceTaskActionResult.msg. Do not edit."""
import sys
...
class DoSurfaceTaskActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "aquacore/DoSurfaceTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','aquacore/DoSurfaceTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DoSurfaceTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = aquacore.msg.DoSurfaceTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = aquacore.msg.DoSurfaceTaskResult()
