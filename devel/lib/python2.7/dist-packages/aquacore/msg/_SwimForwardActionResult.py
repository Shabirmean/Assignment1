...
"""autogenerated by genpy from aquacore/SwimForwardActionResult.msg. Do not edit."""
import sys
...
class SwimForwardActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "aquacore/SwimForwardActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','aquacore/SwimForwardResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SwimForwardActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = aquacore.msg.SwimForwardResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = aquacore.msg.SwimForwardResult()
