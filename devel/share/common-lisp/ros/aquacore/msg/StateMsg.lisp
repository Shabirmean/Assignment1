...
(cl:ensure-generic-function 'LegCurrents-val :lambda-list '(m))
(cl:defmethod LegCurrents-val ((m <StateMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aquacore-msg:LegCurrents-val is deprecated.  Use aquacore-msg:LegCurrents instead.")
  (LegCurrents m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <StateMsg>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'Speed))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'LegCurrents))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <StateMsg>) istream)
  ...
  (cl:setf (cl:slot-value msg 'LegCurrents) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'LegCurrents)))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StateMsg>)))
  ...
  "8f3da9637657db8621e960d32a985a35")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StateMsg)))
  "Returns md5sum for a message object of type 'StateMsg"
  "8f3da9637657db8621e960d32a985a35")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <StateMsg>))
  (cl:+ 0
     ...
     4
     4
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'LegCurrents) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <StateMsg>))
  ...
  (cl:list 'StateMsg
    ...
    (cl:cons ':LegCurrents (LegCurrents msg))
))
