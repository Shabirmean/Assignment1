...
(cl:defmethod cl:initialize-instance :after ((m <StepSimulation-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepSimulation-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aquacore-srv:<StepSimulation-request> is deprecated: use aquacore-srv:StepSimulation-request instead.")))

(cl:ensure-generic-function 'duration-val :lambda-list '(m))
(cl:defmethod duration-val ((m <StepSimulation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aquacore-srv:duration-val is deprecated.  Use aquacore-srv:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepSimulation-request>)))
  ...
  "aquacore/StepSimulationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepSimulation-request)))
  "Returns string type for a service object of type 'StepSimulation-request"
  "aquacore/StepSimulationRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<StepSimulation-request>)))
  ...
  "b3f60a70b50fa6577110da716cb22455")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'StepSimulation-request)))
  "Returns md5sum for a message object of type 'StepSimulation-request"
  "b3f60a70b50fa6577110da716cb22455")
...
(cl:defmethod cl:initialize-instance :after ((m <StepSimulation-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StepSimulation-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aquacore-srv:<StepSimulation-response> is deprecated: use aquacore-srv:StepSimulation-response instead.")))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <StepSimulation-response>))
...
(cl:defmethod frequencies-val ((m <StepSimulation-response>))
...
(cl:defmethod amplitudes-val ((m <StepSimulation-response>))
...
(cl:defmethod leg_offsets-val ((m <StepSimulation-response>))
...
(cl:defmethod phase_offsets-val ((m <StepSimulation-response>))
...
(cl:defmethod joint_angles-val ((m <StepSimulation-response>))
...
(cl:defmethod imu_data-val ((m <StepSimulation-response>))
...
(cl:defmethod integrated_velocity-val ((m <StepSimulation-response>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StepSimulation-response>)))
  ...
  "aquacore/StepSimulationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StepSimulation-response)))
  "Returns string type for a service object of type 'StepSimulation-response"
  "aquacore/StepSimulationResponse")
