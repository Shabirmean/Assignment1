...
class DoSurfaceTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new DoSurfaceTaskFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DoSurfaceTaskActionFeedback
    ...
    bufferOffset = DoSurfaceTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DoSurfaceTaskActionFeedback
    let len;
    let data = new DoSurfaceTaskActionFeedback(null);
    ...
    data.feedback = DoSurfaceTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoSurfaceTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = DoSurfaceTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new DoSurfaceTaskFeedback()
    }
...
module.exports = DoSurfaceTaskActionFeedback;
