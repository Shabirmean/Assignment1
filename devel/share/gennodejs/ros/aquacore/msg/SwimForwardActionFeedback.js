...
class SwimForwardActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SwimForwardFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SwimForwardActionFeedback
    ...
    bufferOffset = SwimForwardFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SwimForwardActionFeedback
    let len;
    let data = new SwimForwardActionFeedback(null);
    ...
    data.feedback = SwimForwardFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SwimForwardActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SwimForwardFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SwimForwardFeedback()
    }
...
module.exports = SwimForwardActionFeedback;
