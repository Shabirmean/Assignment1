...
class DoSurfaceTaskActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new DoSurfaceTaskGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DoSurfaceTaskGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new DoSurfaceTaskActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = DoSurfaceTaskGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DoSurfaceTaskActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = DoSurfaceTaskGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new DoSurfaceTaskGoal()
    }
...
module.exports = DoSurfaceTaskActionGoal;
