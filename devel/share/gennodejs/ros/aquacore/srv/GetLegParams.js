...
class GetLegParamsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetLegParamsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetLegParamsRequest
    let len;
    let data = new GetLegParamsRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetLegParamsRequest(null);
    return resolved;
    }
};

class GetLegParamsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.amplitude = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetLegParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetLegParamsResponse
    let len;
    let data = new GetLegParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetLegParamsResponse(null);
...
module.exports = {
  Request: GetLegParamsRequest,
  Response: GetLegParamsResponse,
  md5sum() { return '1792bf569e4223f89286c37967c01dcf'; },
  datatype() { return 'aquacore/GetLegParams'; }
};
