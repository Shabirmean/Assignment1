...
class GetPeriodicLegCommandRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPeriodicLegCommandRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPeriodicLegCommandRequest
    let len;
    let data = new GetPeriodicLegCommandRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPeriodicLegCommandRequest(null);
    return resolved;
    }
};

class GetPeriodicLegCommandResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.stamp = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPeriodicLegCommandResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPeriodicLegCommandResponse
    let len;
    let data = new GetPeriodicLegCommandResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPeriodicLegCommandResponse(null);
...
module.exports = {
  Request: GetPeriodicLegCommandRequest,
  Response: GetPeriodicLegCommandResponse,
  md5sum() { return 'd3befc8a5e5142617cdb8fa5f1aeaff0'; },
  datatype() { return 'aquacore/GetPeriodicLegCommand'; }
};
