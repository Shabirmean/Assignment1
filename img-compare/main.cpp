...
int main( int argc, char** argv )
{
    ...
    cout << "WORKING LIKE A CHARM" << endl;
...
void MatchingMethod( int, void* )
{
    ...
    cout << matchLoc.x << " and " << matchLoc.y << endl;
    //! [match_loc]
    
    
    float* rowOfMax = result.ptr<float>(matchLoc.y);
    float value = rowOfMax[matchLoc.x];
    cout << "The best val is " << value << endl;
    //Point particlePoint = result.at<CV_32FC1>(376, 82);
